      ...
      <div class="absolute transform left-1/2 -translate-x-1/2 w-96 h-full">
         <div class="relative text-center space-y-6 flex flex-col items-center">
            ...
            <p class="text-gray-500 text-xl max-w-screen-sm">
               ...
               <b>Patrick Nehme</b><br>
               <b>Akhilesh Singh</b><br>
               Musterweg
               12345 Musterstadt
               Vertreten durch:
               Kontakt:
               ...
               <strong>Haftungsausschluss: </strong><br><strong>Haftung für Inhalte</strong><br>
               ...
               Abs.1
               TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§ 8 bis 10
               TMG
               ...
               entfernen.<br><strong>Haftung für Links</strong><br>
               ...
               werden
               wir derartige Inhalte umgehend entfernen.<br><strong>Datenschutz</strong><br>
               ...
               Benutzung
               dieser Website (einschließlich Ihrer IP-Adresse) wird an einen Server von Google in den USA übertragen
               und
               dort
               gespeichert. Google wird diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um
               Reports
               über
               die Websiteaktivitäten für die Websitebetreiber zusammenzustellen und um weitere mit der Websitenutzung
               und
               der
               ...
               bringen. Sie können die Installation der Cookies durch eine entsprechende Einstellung Ihrer Browser
               Software
               ...
               zuvor
               benannten Zweck einverstanden.<br><strong>Google AdSense</strong><br>
               ...
               unsichtbare Grafiken) zur Sammlung von Informationen. Durch die Verwendung des Web Beacons können
               einfache
               Aktionen wie der Besucherverkehr auf der Webseite aufgezeichnet und gesammelt werden. Die durch den
               Cookie
               und/oder Web Beacon erzeugten Informationen über Ihre Benutzung dieser Website (einschließlich Ihrer
               IP-Adresse) werden an einen Server von Google in den USA übertragen und dort gespeichert. Google wird
               diese
               ...
               Dritte
               diese Daten im Auftrag von Google verarbeiten. Google wird in keinem Fall Ihre IP-Adresse mit anderen
               Daten
               der
               Google in Verbindung bringen. Das Speichern von Cookies auf Ihrer Festplatte und die Anzeige von Web
               Beacons
